...
class BaseProjectService extends BaseService {
	...
	async initSetup() { 
		...
		let F = (c) => 'bx_' + c;
		const INSTALL_CL = 'setup_meetfee';
		const COLLECTIONS = ['setup', 'admin', 'log', 'day', 'fav','enroll', 'news', 'temp', 'user', 'enroll_join','lesson_log'];
		const CONST_PIC = '/images/cover.gif';

		const NEWS_CATE = '1=最新通知';
		const ENROLL_CATE = '1=羽毛球场,2=乒乓球场,3=网球场,4=篮球场,5=足球场,6=台球桌,7=棋牌室';
