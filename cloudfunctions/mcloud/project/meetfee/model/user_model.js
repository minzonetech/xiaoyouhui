...
UserModel.DB_STRUCTURE = {
	...
	USER_LESSON_TOTAL_CNT: 'int|true|default=0|comment=当前金额数',
	USER_LESSON_USED_CNT: 'int|true|default=0|comment=已消费金额数',
	USER_LESSON_TIME: 'int|false|comment=最近金额变动时间', 
